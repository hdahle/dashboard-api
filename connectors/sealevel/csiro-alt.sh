...
echo ${DATE}
echo "Getting ftp data from ftp://ftp.csiro.au/legresy/gmsl_files, saving to ${CSVFILE}"
curl "ftp://ftp.csiro.au/legresy/gmsl_files/CSIRO_Alt.csv" > ${CSVFILE}
...
awk -v d="${DATE}" 'BEGIN {
            ...
            print "\"accessed\":\"" d "\", "
            print "\"info\":\"The value per month is the smoothed GSML\", "
