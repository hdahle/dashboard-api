...
function processCSV() {
  ...
  let d = {
    ...
    link: 'https://www.icos-cp.eu/science-and-impact/global-carbon-budget/2020',
    data: []
  }
    ...
    .on('data', csvRow => {
      if (csvRow[1].includes('Source of')) {
        ...
        for (let i = 0; i < nCols - 1; i++) {
          d.data[i] = {
            fuel: csvRow[i + 1].replace('Cement emission', 'Cement').replace('fossil emissions excluding carbonation', 'Total'),
            data: []
          };
        }
